...
public class Statics {
	...
	public static final List<String> infographicList = new ArrayList<String>(Arrays.asList("Eyes"));
	public static String currentInfographicFolder = "";
...
//	public static String inputFolder = "infographic_water"; //this should also be the name of the infographic
	...
	// DATA EXTRACTION
	public static final boolean extractOnlyOnePerson = false;
	public static final String extractName ="Nele Rober";
	...
	public static final List<String> eSensesToExtract = new ArrayList<String>(Arrays.asList("delta", "theta","lowAlpha","highAlpha","lowBeta","highBeta","lowGamma","highGamma"));
	
//	public static final String heatChartsFolder = "heatchartss/";	
	public static final String heatChartsFolder = "rawheatcharts/";	
	public static boolean absoluteHeatChart = false;
}
